...
<div class="mt-2 mb-4 grid grid-cols-2 items-center gap-x-4 gap-y-2">
	...
	<div class="flex items-center gap-1 font-bold">
		<PigMoney />
		{gameState.moneybags[mbName].discoveries.min?.toLocaleString(undefined, numberFormatOptions) ??
...
<button onclick={() => setPage('index')} class="btn md:btn-lg mb-4 w-full md:mb-6">Home</button>
